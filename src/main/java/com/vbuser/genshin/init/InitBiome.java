...
import com.vbuser.genshin.world.biome.testBiome;
...
public class InitBiome {
    ...
    {
        initBiome(BIOME_TEST, "biome_test", BiomeManager.BiomeType.WARM, BiomeDictionary.Type.HILLS, BiomeDictionary.Type.DENSE);
    }
