...
public class ShengYiWuBase extends Item implements IHasModel {
    ...
    public int baseXp(int level){
        ...
        else if(level==2){return 840;}
        else if(level==3){return 1260;}
        else if(level==4){return 2520;}
        else if(level==5){return 3780;}
        else {return 0;}
    }
    ...
    public void addDengJi(ItemStack stack,int add){
        ...
        switch (level){
            case 1:
                if(jy<600){dj=0;}
                if(jy>=600 && jy<1350){dj=1;}
                if(jy>=1350 && jy<2250){dj=2;}
                if(jy>=2250 && jy<3250){dj=3;}
                if(jy>=3250){dj=4;jy=3250;randomNewProperty(stack,false,level,mainProperty);};
            case 2:;//TODO
            case 3:
                if(jy<1800){dj=0;}
                if(jy>=1800 && jy<4025){dj=1;}
                if(jy>=4025 && jy<6675){dj=2;}
                if(jy>=6675 && jy<9775){dj=3;}
                if(jy>=9775 && jy<13325){dj=4;randomNewProperty(stack,true,level,mainProperty);}
                if(jy>=13325 && jy<17325){dj=5;}
                if(jy>=17325 && jy<21825){dj=6;}
                if(jy>=21825 && jy<26825){dj=7;}
                if(jy>=26825 && jy<32075){dj=8;randomNewProperty(stack,true,level,mainProperty);}
                if(jy>=32075 && jy<38150){dj=9;}
                if(jy>=38150 && jy<44775){dj=10;}
                if(jy>=44775 && jy<52000){dj=11;}
                if(jy>=52000){dj=12;jy=52000;randomNewProperty(stack,true,level,mainProperty);};
            case 4:
                if(jy<2400){dj=0;}
                if(jy>=2400 && jy<5375){dj=1;}
                if(jy>=5375 && jy<8925){dj=2;}
                if(jy>=8925 && jy<13050){dj=3;}
                if(jy>=13050 && jy<17775){dj=4;randomNewProperty(stack,hasNBT(stack,"cProperty"),level,mainProperty);}
                if(jy>=17775 && jy<23125){dj=5;}
                if(jy>=23125 && jy<29125){dj=6;}
                if(jy>=29125 && jy<35800){dj=7;}
                if(jy>=35800 && jy<43175){dj=8;randomNewProperty(stack,true,level,mainProperty);}
                if(jy>=43175 && jy<51275){dj=9;}
                if(jy>=51275 && jy<60125){dj=10;}
                if(jy>=60125 && jy<69750){dj=11;}
                if(jy>=69750 && jy<80175){dj=12;randomNewProperty(stack,true,level,mainProperty);}
                if(jy>=80175 && jy<92300){dj=13;}
                if(jy>=92300 && jy<106375){dj=14;}
                if(jy>=106375 && jy<122675){dj=15;}
                if(jy>=122675){dj=16;jy=122675;randomNewProperty(stack,true,level,mainProperty);};
            case 5:
                if(jy<3000){dj=0;}
                if(jy>=3000 && jy<6725){dj=1;}
                if(jy>=6725 && jy<11150){dj=2;}
                if(jy>=11150 && jy<16300){dj=3;}
                if(jy>=16300 && jy<22200){dj=4;}
                if(jy>=22200 && jy<28875){dj=5;randomNewProperty(stack,hasNBT(stack,"dProperty"),level,mainProperty);}
                if(jy>=28875 && jy<36375){dj=6;}
                if(jy>=36375 && jy<44725){dj=7;}
                if(jy>=44725 && jy<53950){dj=8;}
                if(jy>=53950 && jy<64075){dj=9;}
                if(jy>=64075 && jy<75125){dj=10;randomNewProperty(stack,true,level,mainProperty);}
                if(jy>=75125 && jy<87150){dj=11;}
                if(jy>=87150 && jy<100175){dj=12;}
                if(jy>=100175 && jy<115325){dj=13;}
                if(jy>=115325 && jy<132925){dj=14;}
                if(jy>=132925 && jy<153300){dj=15;randomNewProperty(stack,true,level,mainProperty);}
                if(jy>=153300 && jy<176800){dj=16;}
                if(jy>=176800 && jy<203850){dj=17;}
                if(jy>=203850 && jy<234900){dj=18;}
                if(jy>=234900 && jy<270475){dj=19;}
                if(jy>=270475){dj=20;jy=2704750;randomNewProperty(stack,true,level,mainProperty);}
        }
    ...
    public String translateType(int type){
        switch (type){
            case 1:return I18n.format("genshin.syw.h");
            case 2:return I18n.format("genshin.syw.m");
            case 3:return I18n.format("genshin.syw.s");
            case 4:return I18n.format("genshin.syw.b");
            case 5:return I18n.format("genshin.syw.t");
            default:return null;
        }
    }
    ...
    public static String translateProperty(int index){
        switch (index){
            ...
            case 2:return "sm";
            case 3:return "gj";//num
            case 4:return "gj";
            case 5:return "fy";//num
            case 6:return "fy";
            case 7:return "cn";
            case 8:return "jt";
            case 9:return "bj";
    ...
    public int randomValue(int type){
        ...
        if(type==1){return h[(int)(Math.random() * 4)];}
        else if(type==2){return c[(int)(Math.random() * 4)];}
        else if(type==3){return g[(int)(Math.random() * 4)];}
        else if(type==4){return c[(int)(Math.random() * 4)];}
        else if(type==5){return i[(int)(Math.random() * 4)];}
        else if(type==6){return d[(int)(Math.random() * 4)];}
        else if(type==7){return e[(int)(Math.random() * 4)];}
        else if(type==8){return i[(int)(Math.random() * 4)];}
        else if(type==9){return a[(int)(Math.random() * 4)];}
        else if(type==10){return b[(int)(Math.random() * 4)];}
        else{return 0;}
    }
