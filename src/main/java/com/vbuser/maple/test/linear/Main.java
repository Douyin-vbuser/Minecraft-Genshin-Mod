...
import com.vbuser.maple.nn.LinearNet;
import com.vbuser.maple.optimizer.Optimizer;
import com.vbuser.maple.optimizer.SGD;

public class Main {
    public static void main(String[] args) {
        AutogradTensor inputs = new AutogradTensor(new double[]{
                1, 2, 3, 4, 5
        }, new int[]{5, 1});

        AutogradTensor targets = new AutogradTensor(new double[]{
                2, 4, 6, 8, 10
        }, new int[]{5, 1});
        ...
        LinearNet model = new LinearNet(1, 1, optimizer, lossFunction,true);
